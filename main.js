...
function aboutMe(){
    ...
    if(i==0){
        ...
        slogan2.innerHTML="这里是Viper，原名一丞，一个伪程序员. 我能熟练掌握面向现实编程，C语言的使用、Python编译器的使用、CSSHTML的使用，还喜欢玩Minecraft！（（（。。。生命不息，折腾不止！目前坐等高考中...";
    } else {
        i=0;
        slogan.style.height="50px";
        slogan2.innerHTML="This  is  Viper / This  is  Yicheng";
    }
